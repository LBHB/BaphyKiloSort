...
%reload_job_table
    ...
    function save_to_db_callback(Hobj,ev)
        ...
        [s, button] = settingsdlg(...
            ...
            {'Keep units with zero resp over all files'; 'keep_zero_resp_units'}, false,...
            {'Purge rawids'; 'purge_rawids'}, true,...
            {'Don''t save these ids';'remove_ids'},'',...
            {'Delete existing file'; 'delete_existing_spkfile'}, false);
