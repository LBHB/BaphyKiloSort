function ops=UTkilosort_default_parameters
global SERVER_PATH
...
ops.use_parfor          = ops.GPU; % whether to use parfor to accelerate some parts of the algorithm		
...
ops.nNeigh              = 20; % visualization only (Phy): number of neighboring templates to retain projections of (16)		
...
PCspikes_pth=[SERVER_PATH 'code' filesep 'KiloSort' filesep 'PCspikes2.mat'];
dd                  = load(PCspikes_pth'); % you might want to recompute this from your own data		
